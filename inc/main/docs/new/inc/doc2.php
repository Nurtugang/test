                    ...
                    <div class="form-group">
                        ...
                        <select class="single-select" id="todatals1" data-placeholder="Подпись руководителя проекта/работы" style="width: 100%;">
                            ...
                            $sql = "SELECT tutors.TutorID,tutors.lastname,tutors.firstname,tutors.patronymic FROM tutors WHERE has_access = 1 order by tutors.lastname,tutors.firstname,tutors.patronymic";
                            $res = $con->query($sql);
