<div class="form-group">
    <label>Кому:</label>
    <select class="select2"  id="todata" data-placeholder="Кому адресован документ" style="width: 100%;">
        <?php
...
<div class="form-group">
    ...
    <select class="select2" id="todatals1" data-placeholder="Окончательное согласование" style="width: 100%;">
...
<div class="form-group">
    ...
    <select class="multiple-select" multiple="multiple" id="todatals2" data-placeholder="Согласование" style="width: 100%;">
        ...
        $sql = "SELECT tutors.TutorID,tutors.lastname,tutors.firstname,tutors.patronymic from tutors where tutorid in (4687)";
                            $res = $con->query($sql) or die($sql);
    ...
    <h3>ПРИМЕЧАНИЕ: Укажите дату командировки с учетом дороги.</h3>
</div>