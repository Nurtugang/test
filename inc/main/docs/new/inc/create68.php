...
$sql = "insert into documents(author,name,status,filename,dir,doctypeid,roleid) values(".$_SESSION['personid'].",'$namedoc (".$_SESSION['fio'].")',1,'".$_SESSION['personid'].".pdf','',$doctypeid,1)";
