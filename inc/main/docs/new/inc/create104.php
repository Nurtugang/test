...
$sql = "insert into documentsignlists(documentid,personid,type,roleid) values($documentid,2395,1,2)";
$condocs->query($sql);
...
$foter='<p>ҚР 2003 жылғы 7 қаңтар № 370 «Электрондық құжат және электрондық цифрлық қолтаңба туралы» заңының 7б. сәйкес қол қоюға өкілеттігі бар адамның электрондық цифрлық қолтаңбасы арқылы куәландырылған электрондық құжат қағаз жеткізгіштегі қол қойылған құжатпен бірдей болып табылады.</p>';
